...
Meio a essa instigante área, um dos assuntos bastante pesquisados são as decisões de investimento. \citeonline{babaei2022explainable}, aborda a relevância da alocação de ativos em portfólios, abordando como distribuir os recursos financeiros entre as oportunidades de investimento disponíveis, prática que visa mitigar o risco e máximizar o retorno. Segundo \citeonline{almansour2023behavioral}, varios estudos debruçam sobre o impacto das finanças comportamentais em decisões de investimento. Nesse sentido,
\citeonline{adil2022financial}, complementa sobre a importancia da educação financeira na tomada de decisões de investimento bem informadas, o autor cita que a baixa alfabetização financeira gera tomadas de decisões irracionais e desfavoráveis, com pouca diversificação. Mas, \citeonline{paiva2014redes}, diz que a possibilidade de prever preços futuros em ativos financeiros a fim de obter ganhos anormais, contraria a teoria financeira dominante, a Hipótese de Mercado Eficiente (HME), mainstream das Finanças Modernas. A HME denota ineficácia na previsão de preços do mercado se utilizando de informações passadas. A afirmativa é justificada pelo pressuposto de movimento browniano da HME, concebido por características randômicas e independentes. Entretanto, \citeonline{paiva2014redes} pontua que há estudos que defendem que o mercado acionário, na verdade, não se firma como aleatório e as séries financeiras têm memória de longo-prazo. De tal maneira que, caso seja possível identificar os padrões de comportamento do mercado, se tornaria plausível uma abordagem preditiva.
