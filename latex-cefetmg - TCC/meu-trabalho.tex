...
% Pacotes utilizados
% -----------------------------------------------------------------------------
\usepackage{acro} %para lista de acronimos e abreviaturas
\usepackage{setspace}
...
%precisa estar aqui pela função DeclareAcronym
\input{elementos-pre-textuais/lista-siglas.tex} 
...
\imprimirlistadesiglas                            % (opcional) Lista de siglas
\clearpage
